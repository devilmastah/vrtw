...
class HaversineDistanceCalculatorTest {
    ...
    void calculateDistance() {
        ...
        Assertions.assertThat(distanceCalculator.calculateDistance(Gent, Brno, false))
        ...
        Assertions.assertThat(distanceCalculator.calculateDistance(Svolvaer, Lulea, false))
